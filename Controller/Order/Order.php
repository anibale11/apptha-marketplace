    ...
    public function execute() {
        ...
        if ($sellerOrderItems->getSellerId () == $sellerId) {
            ...
            if ($action == 'canceled' || $action == 'returned') {
                ...
                $orderItemCount = is_countable ( $orderItems );
                if ($action == 'canceled') {
                    $orderItems->addFieldToFilter ( 'is_canceled', 1 );
                } else {
                    $orderItems->addFieldToFilter ( 'is_returned', 1 );
                }
                $canceledOrderItemCount = is_countable ( $orderItems );
                ...
                $allItemsCount = is_countable ( $allItems );
                ...
                $allSellerOrderItemCount = is_countable ( $allSellerOrderItem );
